...
import imgCalculator from '../../assets/images/AboutUs/HealthCalc.png';
import imgMeal from '../../assets/images/AboutUs/MealSche.png';
import imgTracker from '../../assets/images/AboutUs/CalorieTracker.png';
import imgRecipe from '../../assets/images/AboutUs/RecipeFind.png';


function FourFitur() {
  return (
    <div className="FourFitur bg-slate-50">
        <section id="Fitur" className="flex items-center justify-center flex-col bg-red w-full">
        <h1 className="text-5xl sm:text-8xl text-center text-slate-500 font-extrabold py-3 mb-3 drop-shadow-lg font-poppins">
            Our Features
        </h1>
