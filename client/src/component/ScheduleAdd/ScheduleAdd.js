...
function ScheduleAdd() {
    ...
    ]); // State untuk menyimpan kumpulan section
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (response.status === 201) {
                ...
                // Reset state atau navigasi ke halaman lain
            }
        } catch (error) {
            ...
            <div className="relative">
                ...
                <div className="w-full justify-center items-center flex">
                    <div className="sm:w-[80%] w-full flex justify-end items-center px-8"
                        onClick={handleSave}
                        >
                            <button className="mt-10 py-2 px-5 sm:py-3 sm:px-8 rounded-3xl text-base bg-[#2cd24d] font-pop sm:text-xl font-semibold tracking-wider text-white hover:scale-105 hover:brightness-95 transition duration-300 ease-in-out active:scale-100">Save</button>
                    </div>
                </div>
            </div>
            )}   
