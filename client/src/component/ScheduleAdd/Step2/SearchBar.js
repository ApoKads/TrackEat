        ...
        <div className='w-full gap-4 flex justify-center items-center px-4 py-2'>
                <div className='w-full flex gap-2'>
                    <input type="text" placeholder='Search food...'
                     ...
                     style={{ boxShadow: '0 1px 2px rgba(0, 0, 0, 0.1)' }} className='bg-background shadow-inner w-72 lg:w-96 p-2 rounded-lg focus:outline-none focus:placeholder-transparent focus:border-solid focus:border-slate-600 focus:border-2 transition duration-100 ease-in-out' />
