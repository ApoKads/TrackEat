        ...
        <div className="w-full flex justify-between ">
          ...
          {food.user_id!==0 && (<div className="flex gap-4">
            ...
            <button onClick={handleNavigate}
              className="flex justify-center items-center rounded-md bg-ourLime text-black text-sm sm:text-base sm:px-4 sm:py-2 w-24 sm:w-32 hover:scale-105 active:scale-95 transition duration-300 ease-in-out"
              >
              Edit Food
            </button>
          </div>)}
              ...
              <div className="card1 p-8 bg-white bg-opacity-90 rounded-lg shadow-lg space-y-6 ">
                  <div className="flex flex-col gap-4  items-center">
                      ...
                      <div className="nutrients flex flex-col  w-full md:w-3/4  gap-4">
                          ...
                          {/* Section Quantity */}
                          <div className="flex  h-12 items-center gap-2 sm:gap-4 w-full justify-between">
                              <button
                                onClick={decreaseQuantity}
                                className="bg-gray-200 flex w-[2.5rem] h-full justify-center items-center rounded-lg shadow-md text-lg font-semibold hover:bg-ourLime transition-transform transform hover:scale-105 active:scale-95"
                              >
                                -
                              </button>
                              <input
                                ...
                                className="p-2 text-center flex h-full no-spinner w-2/3"
                                min="1"
                              />
                              <button
