...
function ActivitySection(props)
{
    const [showError, setShowError] = useState(false);
        ...
        return <div class="w-full h-[80vh] up-6 rounded-t-3xl sm:w-[400px] text-center shadow-lg relative overflow-hidden bg-[#FAF6EF] flex flex-col  gap-2">
    
        <div class="w-full h-10 bg-lime-400"></div>
        <div className="flex flex-col gap-1">
            <h2 class="text-2xl font-bold text-black">What's your activity level?</h2>
